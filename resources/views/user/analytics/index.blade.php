                                    ...
                                    <div class="exam-overview"> 
                                        <div class="exam-overview-content">
                                            ...
                                            <div class="overview-graph">
                                                <div class="overview-graph-body">
                                                    <div class="overview-graph-inner"> 
                                                        <canvas id="question-bank-chart-{{$item->id}}"  @if(isset($category_value[$item->id])) data-avg="{{ $category_value[$item->id] }}"  @else data-avg="{{$item->getExamAvgPercentage('question-bank')}}" @endif data-mrk="{{$item->getExamMarkPercentage('question-bank',auth()->id())}}"   data-max="100" class="overview-graph-bar overview-graph-bar-question-bank" width="100%" ></canvas>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
