                    ...
                    $.each(res.links, function(k, v) {
                        ...
                        if (v.active || !v.url) {
                            ...
                            $('#lesson-footer-paginationmobile').append(`
                                <button class="${linkstatus} btn btn-secondary ${res.data[k - 1].time_taken}  ${preclass} ${v.active?"active":""}" disabled   >${label_name}</button>
                            `)
                        } else {
                            $('#lesson-footer-paginationmobile').append(`
                                <button class="${linkstatus} btn btn-secondary ${res.data[k - 1].time_taken} " onclick="loadlessonreview('${v.url}')" >${v.label}</button>
                            `)
                        }
