...
<section class="exam-footer"> 
    <div class="lesson-pagination">
        ...
        <a class="lesson-exit float-start button left-btn " href="{{route('question-bank.set.complete',$userExamReview->slug)}}"  title="Exit" data-title="Exit" aria-label="Exit" data-toggle="tooltip">
            Back
    </a>
