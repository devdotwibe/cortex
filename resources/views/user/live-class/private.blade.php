              ...
              @endguest
                ...
                <div class="timetable-wrapp">
                    ...
                    <div class="timetable-row">
                        <p>
                            {{ $timetable->day }}
                            ( {{ $timetable->starttime }} {{ strtolower($timetable->starttime_am_pm) }} - {{ $timetable->endtime }} {{ strtolower($timetable->endtime_am_pm) }} ) ({{ $timetable->type }}) {{  $timetable->term_year ? '-' .$timetable->term_year :'' }}
                        </p>
