...
@push('footer-script')
    <script>
        ...
        function loadlessonreview(reviewurl) {
            $.get(reviewurl ||
                "{{ route('full-mock-exam.retry.preview', ['user_exam_review' => $userExamReview->slug, 'exam_retry_review' => $examRetryReview->slug]) }}",
                function(res) {
                    ...
                    `).fadeIn();
                        $.get("{{ route('full-mock-exam.retry.preview', ['user_exam_review' => $userExamReview->slug, 'exam_retry_review' => $examRetryReview->slug]) }}", {
                            question: v.slug
                        }, function(ans) {
