                ...
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <button type="button" class="close" data-bs-dismiss="modal" aria-label="Close">
                            <img src="{{ asset('assets/images/x-circle.svg') }}" alt="Close">
                        </button>
                    </div>
                    <div class="modal-body" style="max-height: 400px; overflow-y: auto;">
                        <form action="#" name="import_user" id="import_user" method="post" enctype="multipart/form-data">
                            ...
                            <div class="col-md-12 mb-3">
                                ...
                                <input type="file" accept=".csv,.xlsx" name="file_upload" id="file_upload" class="form-control" required>
                            </div>
        
                            <div class="mb-3">
                                <label for="first_name" class="form-label">First Name:</label>
                                <select class="form-control import-fields" name="first_name" id="first_name" data-value="first_name" required>
                            ...
                            <div class="mb-3">
                                ...
                                <select class="form-control import-fields" name="last_name" id="last_name" data-value="last_name" required>
                                    <option value="">--Select--</option>
                                </select>
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <select class="form-control import-fields" name="email" id="email" data-value="email" required>
                                    <option value="">--Select--</option>
                                </select>
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <select class="form-control import-fields" name="grade" id="grade" data-value="grade" required>
                                    <option value="">--Select--</option>
                                </select>
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control datepicker end-datepicker" name="expiry_date" id="expiry_date" readonly required>
                            </div>
                            ...
                            <div class="d-flex justify-content-end">
                                <button class="btn btn-danger me-2" type="submit" aria-label="Confirm">
                                    Import
