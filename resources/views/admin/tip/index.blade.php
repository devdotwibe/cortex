                            ...
                            <div class="category">
                                ...
                                <div class="category-content">
                                    ...
                                    <h5>
                                        ...
                                        <i id="category-content-subtitle-edit-3" onclick="editsubtitle(event,this)" data-title="{{$item->name}}" data-icon="{{asset("assets/images/User-red.png")}}"  data-subtitle="{{$item->name}}" data-category="{{$item->id}}">
