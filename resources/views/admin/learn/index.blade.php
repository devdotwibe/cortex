...
<section class="content_section admin_section learn-class">
    <div class="container">
        <div class="row">
                        ...
                        <div class="card-body">
                            <div class="category">
                                <div class="category-image">
                                    <img src="{{$exam->examIcon($item->id,asset("assets/images/learnuser-red.png"))}}" id="category-content-icon-{{$item->id}}">
                                </div>
