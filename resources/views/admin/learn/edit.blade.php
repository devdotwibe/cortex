    ...
    <div class="header_wrapp">
        <div class="header_title">
            <div class="back-btn" id="back-btn" style="display: block"> <!-- Ensure proper display value -->
                <a href="{{ route('admin.learn.show',$category->slug) }}">
...
<section class="invite-wrap mt-2">
    <div class="container">
        ...
        <x-edit-form name="admin.learn" id="c" :params="[$category->slug,$learn->slug]" :cancel="route('admin.learn.show',$category->slug)"  btnsubmit="Save" :fields='[
            ...
            ["name"=>"short_answer", "addclass"=>"short_section" ,"display"=>"none" , "placeholder"=>"Type Answer Here","label"=>"Answer","size"=>12,"type"=>"editor" ,"value"=>$learn->short_answer,], 
