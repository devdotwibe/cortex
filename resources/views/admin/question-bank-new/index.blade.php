    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-6">
                ...
                <a  onclick="loadsubcategory('{{route('admin.question-bank-new.subcategory',$item->slug)}}')">
                    <div class="card mt-4">
                        <div class="card-body">
                            <div class="category">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="{{route('admin.question-bank-new.subtitle')}}"  id="question-bank-subtitle-form" method="post">
                    @csrf
...
<script>
    ...
    $(function(){
        $('#question-bank-subtitle-form').submit(function(e){
            ...
            $.post('{{route('admin.question-bank-new.subtitle')}}',$(form).serialize(),function(res){
                form.reset()
