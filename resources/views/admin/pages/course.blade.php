    ...
    <section class="invite-wrap mt-2">
        <div class="container">
            ...
            <ul class="nav nav-tabs" id="myTab" role="tablist">
                ...
                <li class="nav-item" role="presentation">
                    <a class="nav-link @if (old('section') == 'section2') active @endif @if(session('tab_1') == true)  show active @else @endif " id="section2-tab"
            ...
            <div class="tab-content" id="myTabContent">
                                ...
                                <form action="{{ route('admin.course.section1') }}" method="POST"
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div id="imagePreviewContainer" style="border: 1px solid #ddd; padding: 10px; display: flex; align-items: center;">
                                                <div style="flex: 1;">
                                                    @if (isset($course) && $course->image)
                                                        <img id="imagePreview" src="{{ url('storage/' . $course->image) }}" alt="Image Preview" style="width: 150px; height: auto;">
                                                    @else
                                                        <img id="imagePreview" src="#" alt="Image Preview" style="display: none; width: 150px; height: auto;">
                                                    @endif
                                                </div>
                                                @if (isset($course) && $course->image)
                                                    <div style="margin-left: 10px;">
                                                        <form action="{{ route('admin.course.deleteImage') }}" method="POST">
                                                            @csrf
                                                            @method('DELETE')
                ...
                <div class="tab-pane fade @if (old('section') == 'section2') show active @endif @if(session('tab_1') == true)  show active @else @endif " id="section2"
                    ...
                    <ul class="nav nav-tabs" id="section2Tabs" role="tablist">
                        <li class="nav-item" role="presentation">
                            <a class="nav-link @if (old('sub_section') == 'tab1' || old('sub_section') == '') active @endif @if(session('tab_1') == true) active @else @endif " id="tab1-tab"
                    ...
                    <div class="tab-content mt-2" id="section2TabContent">
                        <!-- Tab 1 -->
                        <div class="tab-pane fade @if (old('sub_section') == 'tab1' || old('sub_section') == '') show active @endif @if(session('tab_1') == true)  show active @else @endif "  id="tab1"
