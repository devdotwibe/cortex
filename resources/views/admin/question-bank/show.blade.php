...
<section class="header_nav">
    <div class="header_wrapp">
        <div class="header_title">
            ...
            <h2>
                <a href="{{ route('admin.question-bank.index', ['id' => $category->id,'type' =>'category']) }}">{{$category->name}}</a> -> 
                <a href="{{ route('admin.question-bank.index', ['id' => $subcategory->id,'type' =>'subcategory']) }}">{{$subcategory->name}}</a> -> 
