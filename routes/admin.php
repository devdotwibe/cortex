...
Route::name('admin.')->prefix('admin')->group(function () {
    ...
    Route::middleware(['auth:admin', 'isAdmin'])->group(function () {
        ...
        Route::middleware(['AdminPermission:users'])->group(function () {
            ...
            Route::post('/user/upgrade_user', [UserController::class, 'upgrade_user'])->name('user.upgrade_user');
            ...
            Route::post('/user/freeaccess', [UserController::class, 'freeaccess'])->name('user.freeaccess');
        ...
        Route::middleware(['AdminPermission:full_mock_exam'])->group(function () {
