...
Route::middleware(['auth', 'isUser'])->group(function () {
    ...
    Route::middleware('verified')->group(function () {
        ...
        Route::prefix('question-bank')->name('question-bank.')->group(function () {
            ...
            Route::middleware('subscription:question-bank')->get('/{category}/{sub_category}/set/{setname}/attempt', [ExamQuestionController::class, 'setattempt'])->name('set.attempt');
        ...
        Route::prefix('topic-test')->name('topic-test.')->group(function () {
            ...
            Route::get('/{user_exam}/questions', [TopicExamController::class, 'questions'])->name('questions');
        ...
        Route::prefix('full-mock-exam')->name('full-mock-exam.')->group(function () {
            ...
            Route::get('/{userExamReview}/chart-data', [MockExamController::class, 'mockChartData'])->name('chart-data');
