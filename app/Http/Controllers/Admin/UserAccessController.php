...
class UserAccessController extends Controller
{
    ...
    public function user_update(Request $request, User $user)
    {
        ...
        foreach ($request->term ?? [] as $termname) {
            ...
            foreach (ClassDetail::whereRaw('BINARY term_name = ?', [$termname])->get() as $term) {
            ...
            foreach (LessonMaterial::whereRaw('BINARY term_name = ?', [$termname])->get() as $term) {
            ...
            foreach (HomeWork::whereRaw('BINARY term_name = ?', [$termname])->get() as $term) {
            ...
            foreach (LessonRecording::whereRaw('BINARY term_name = ?', [$termname])->get() as $term) {
