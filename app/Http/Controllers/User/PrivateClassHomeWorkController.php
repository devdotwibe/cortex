    ...
    public function show(Request $request, HomeWork $homeWork)
{
    ...
    // Check if the user has access to the homework
    $termAccessExists = TermAccess::where('type', 'home-work')
    ...
    // Retrieve related booklets where term_name and title are not null
